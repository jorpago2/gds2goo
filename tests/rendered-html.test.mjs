...
test("exports the GDS2GOO application shell", async () => {
  ...
  assert.match(html, /Convert a GDSII layout/);
  assert.match(html, /NATIVE RASTER/);
  assert.match(html, /Elegoo Mars 4/);
  assert.match(html, /Generate \.GOO/);
  ...
  assert.match(html, /WORKFLOW GUIDE/);
  ...
  assert.match(html, /Experiment bundle/);
  assert.match(html, /Experimental run sheet/);
