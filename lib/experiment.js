...
/**
 * Substrate-fit validation applies to imported device layouts. Built-in
 * calibration and orientation patterns characterize the printer LCD itself,
 * so comparing their full-screen geometry with the selected sample substrate
 * would produce a misleading warning.
 */
export function requiresSubstrateValidation(sourceKind) {
  return sourceKind === "gds";
}
