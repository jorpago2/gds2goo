...
- Opens with a 43.0 × 14.4 mm Universitat de València logo GDS on a 2-inch wafer with a primary flat and cross alignment marks.
...
The profile is fixed to the Mars 4 9K (153.36 × 77.76 mm, 18 µm/pixel), one 0.05 mm layer and 9 s as an initial value. The 9 s value comes from [Wu et al., *Small Methods* 9 (2025), e01336](https://doi.org/10.1002/smtd.202501336), for LOR2A/AZ1505 and does not replace a process-specific dose matrix. Always verify the PNG, polarity and on-screen orientation without a sample before exposing photoresist.
